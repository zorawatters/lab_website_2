...
function loadStatsPage() {
	...
	for(rowCount = 2; rowCount < table.rows.length; rowCount++)
		{
			homeScore = table.rows[rowCount].cells[2].innerHTML;
			oppScore = table.rows[rowCount].cells[3].innerHTML;
...
function loadPlayersPage() {
	var dex;
	for (dex = 0; dex < players.length; dex++)
	{
		var a = document.createElement('A');
		a.addEventListener("click", switchPlayers(dex));
		a.href = "#";
		a.innerHTML = players[dex].name;
...
function switchPlayers(playerNum) {
	...
	avgP = Math.round(players[playerNum].pass_yards / players[playerNum].games_played);
	avgR = Math.round(players[playerNum].rushing_yards / players[playerNum].games_played);
	avgRec = Math.round(players[playerNum].receiving_yards / players[playerNum].games_played);
